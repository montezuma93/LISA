...
Sequence:
Seq. 0    Driver:Jen    Recip : LTM    Fire control:groups (QUESTION)     Goals: EXPLAIN RETRIEVE     Phase set: P1:DRINK (JEN, OJ)
...
From LTM to Jen:
  ...
  Props:
    From P9 to:    P1 = 0.990
  SPs:
    From SP9.1 to:    SP1.1 = 0.993
    From SP9.2 to:    SP1.2 = 0.993
  Preds:
    From DRINK1 to:    DRINK1 = 0.968
    From DRINK2 to:    DRINK2 = 0.968
  Objs:
    From OJ to:    OJ = 0.968
    From JOAN to:    JEN = 0.968
...
From Jen to LTM:
  ...
  Props:
    From P1 to:    P9 = 0.990
  SPs:
    From SP1.1 to:    SP9.1 = 0.993
    From SP1.2 to:    SP9.2 = 0.993
  Preds:
    From DRINK1 to:    DRINK1 = 0.968
    From DRINK2 to:    DRINK2 = 0.968
  Objs:
    From OJ to:    OJ = 0.968
    From JEN to:    JOAN = 0.968
