...
* * * * * * * * * * * * * * * * * * * * * * * * * * * 
Batch: 10 runs of az/oj_easy2_mike
* * * * * * * * * * * * * * * * * * * * * * * * * * * 
...
Seq. 6    Driver:WorkSpace    Recip : Mike    Fire control:groups-d    Goals: EXPLAIN INFER     Phase set: P13:DRINK (SALLY, OJ)
Seq. 7    Driver:WorkSpace    Recip : Mike    Fire control:groups-d    Goals: EXPLAIN INFER     Phase set: P12:ISA (SALLY, DIVORCEE)
...
* * * * * * * * * * * * * * * * * * * * * * * * * * * 
Batch: 10 runs of az/oj_easy2_jen
* * * * * * * * * * * * * * * * * * * * * * * * * * * 
...
Sequence:
Seq. 0    Driver:Jen    Recip :    Fire control:groups (QUESTION)     Goals: EXPLAIN RETRIEVE     Phase set: P1:DRINK (OJ)
Seq. 1    Driver:Jen    Recip : WorkSpace    Fire control:groups-d    Goals: EXPLAIN MAP     Phase set: P1:DRINK (OJ)
...
* * * * * * * * * * * * * * * * * * * * * * * * * * * 
Batch: 10 runs of az/oj_easy2_bill
* * * * * * * * * * * * * * * * * * * * * * * * * * * 
...
Seq. 2    Driver:WorkSpace    Recip : Bill    Fire control:groups-d    Goals: EXPLAIN INFER     Phase set: P9:DRINK (LARRY, OJ)
Seq. 3    Driver:WorkSpace    Recip : Bill    Fire control:groups-d    Goals: EXPLAIN INFER     Phase set: P8:HAS (LARRY, FETISH)
Seq. 4    Driver:WorkSpace    Recip : Bill    Fire control:groups-d    Goals: EXPLAIN INFER     Phase set: P11:DRINK (JOAN, OJ)
Seq. 5    Driver:WorkSpace    Recip : Bill    Fire control:groups-d    Goals: EXPLAIN INFER     Phase set: P10:ISA (JOAN, MECHANIC)
Seq. 6    Driver:WorkSpace    Recip : Bill    Fire control:groups-d    Goals: EXPLAIN INFER     Phase set: P13:DRINK (SALLY, OJ)
Seq. 7    Driver:WorkSpace    Recip : Bill    Fire control:groups-d    Goals: EXPLAIN INFER     Phase set: P12:ISA (SALLY, DIVORCEE)
...
* * * * * * * * * * * * * * * * * * * * * * * * * * * 
Batch: 10 runs of az/oj_easy2_mary
* * * * * * * * * * * * * * * * * * * * * * * * * * * 
...
Seq. 4    Driver:WorkSpace    Recip : Mary    Fire control:groups-d    Goals: EXPLAIN INFER     Phase set: P11:DRINK (JOAN, OJ)
Seq. 5    Driver:WorkSpace    Recip : Mary    Fire control:groups-d    Goals: EXPLAIN INFER     Phase set: P10:ISA (JOAN, MECHANIC)
...
Seq. 2    Driver:WorkSpace    Recip : Mary    Fire control:groups-d    Goals: EXPLAIN INFER     Phase set: P9:DRINK (LARRY, OJ)
Seq. 3    Driver:WorkSpace    Recip : Mary    Fire control:groups-d    Goals: EXPLAIN INFER     Phase set: P8:HAS (LARRY, FETISH)
Seq. 4    Driver:WorkSpace    Recip : Mary    Fire control:groups-d    Goals: EXPLAIN INFER     Phase set: P13:DRINK (SALLY, OJ)
Seq. 5    Driver:WorkSpace    Recip : Mary    Fire control:groups-d    Goals: EXPLAIN INFER     Phase set: P12:ISA (SALLY, DIVORCEE)
...
* * * * * * * * * * * * * * * * * * * * * * * * * * * 
Run 9 of az/oj_easy2_mary
* * * * * * * * * * * * * * * * * * * * * * * * * * * 

Sequence:
Seq. 0    Driver:Mary    Recip :    Fire control:groups (QUESTION)     Goals: EXPLAIN RETRIEVE     Phase set: P1:DRINK (MARY, OJ)
Seq. 1    Driver:Mary    Recip : WorkSpace    Fire control:groups-d    Goals: EXPLAIN MAP     Phase set: P1:DRINK (MARY, OJ)
Seq. 2    Driver:WorkSpace    Recip : Mary    Fire control:groups-d    Goals: EXPLAIN INFER     Phase set: P11:DRINK (JOAN, OJ)
Seq. 3    Driver:WorkSpace    Recip : Mary    Fire control:groups-d    Goals: EXPLAIN INFER     Phase set: P10:ISA (JOAN, MECHANIC)
