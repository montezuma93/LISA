...
Props:
'P1':  [ DRINK1 + 'JOAN' ] [ DRINK2 + OJ ] 
'P2':  [ 'ISA1' + 'JOAN' ] [ 'ISA2' + 'MECHANIC' ] 
'P3':  [ 'ISA1' + MARY ] [ 'ISA2' + 'DIVORCEE' ] 
...
Seq. 11    Driver:WorkSpace    Recip : Bill    Fire control:groups-d    Goals: EXPLAIN INFER     Phase set: P13:DRINK (SALLY, OJ)
Seq. 12    Driver:WorkSpace    Recip : Bill    Fire control:groups-d    Goals: EXPLAIN INFER     Phase set: P12:ISA (SALLY, DIVORCEE)
...
Seq. 7    Driver:WorkSpace    Recip : Bill    Fire control:groups-d    Goals: EXPLAIN INFER     Phase set: P6:ALERTING (OJ)
Seq. 8    Driver:WorkSpace    Recip : Bill    Fire control:groups-d    Goals: EXPLAIN INFER     Phase set: P7:EXTRINSIC_CAUSE (OJ)
Seq. 9    Driver:WorkSpace    Recip : Bill    Fire control:groups-d    Goals: EXPLAIN INFER     Phase set: P13:DRINK (SALLY, OJ)
Seq. 10    Driver:WorkSpace    Recip : Bill    Fire control:groups-d    Goals: EXPLAIN INFER     Phase set: P12:ISA (SALLY, DIVORCEE)
...
Seq. 13    Driver:WorkSpace    Recip : Bill    Fire control:groups-d    Goals: EXPLAIN INFER     Phase set: P13:DRINK (SALLY, OJ)
Seq. 14    Driver:WorkSpace    Recip : Bill    Fire control:groups-d    Goals: EXPLAIN INFER     Phase set: P12:ISA (SALLY, DIVORCEE)
