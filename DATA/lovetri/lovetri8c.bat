...
From Amy&Bill to Abe&Beth:
  ...
  SPs:
    ...
    From SP3.2 to:    "SP3.2" = 0.993
  Preds:
    From LOVES1 to:    LOVES1 = 0.969
    From LOVES2 to:    LOVES2 = 0.969
    From JEALOUS1 to:    "JEALOUS1" = 0.970
    From JEALOUS2 to:    "JEALOUS2" = 0.970
  Objs:
    From AMY to:    BETH = 0.970
    From BILL to:    BETH = 0.099    CHAD = 0.970
    From CAT to:    ABE = 0.970
...
From Abe&Beth to Amy&Bill:
  ...
  Preds:
    ...
    From "JEALOUS1" to:    JEALOUS1 = 0.970
  Objs:
    From ABE to:    CAT = 0.970
    From BETH to:    AMY = 0.970    BILL = 0.099
    From CHAD to:    BILL = 0.970
