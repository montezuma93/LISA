...
* * * Current Mapping Connections From Explanandum to WorkSpace * * *
  Groups:
    From EFFECT2 to:    EFFECT1 = 0.879
    From 'CE-4' to:    CE-1 = 0.879
    From 'CAUSE5' to:    CAUSE1 = 0.879
  Props:
    From 'P1' to:    P3 = 0.982
    From 'P2' to:    P1 = 0.990
    From 'P3' to:    P2 = 0.982
  ...
  Preds:
    From 'IMMORAL1' to:    WAS-IMMORAL1 = 0.970
...
* * * Current Mapping Connections From Explanandum to WorkSpace * * *
  Groups:
    From 'EFFECT7' to:    EFFECT2 = 0.879
    From 'CE-8' to:    CE-2 = 0.879
    From 'CAUSE9' to:    CAUSE2 = 0.879
  Props:
    From 'P1' to:    P3 = 0.982
    From 'P4' to:    P5 = 0.982
    From 'P5' to:    P4 = 0.990
  SPs:
    From 'SP2' to:    SP3.1 = 0.992
    From 'SP6' to:    SP5.1 = 0.987
    From 'SP7' to:    SP4.1 = 0.990
    From 'SP8' to:    SP4.2 = 0.990
  Preds:
    From 'IMMORAL1' to:    WAS-IMMORAL1 = 0.970
...
Seq. 0    Driver:Explanandum    Recip :    Fire control:groups    Goals: EXPLAIN RETRIEVE RETRIEVE     Phase set: P1
Seq. 1    Driver:Explanandum    Recip : WorkSpace    Fire control:groups-d    Goals: EXPLAIN RETRIEVE MAP     Phase set: P1
Seq. 2    Driver:WorkSpace    Recip : Explanandum    Fire control:groups-d    Goals: EXPLAIN RETRIEVE INFER     Phase set: P5
Seq. 3    Driver:WorkSpace    Recip : Explanandum    Fire control:groups-d    Goals: EXPLAIN RETRIEVE INFER     Phase set: P3
Seq. 4    Driver:WorkSpace    Recip : Explanandum    Fire control:groups-d    Goals: EXPLAIN RETRIEVE INFER     Phase set: P4
